...
//        Código
    ...
    private void addRows(PdfPTable table, List<Producto> productos) {
        for (Producto producto : productos) {
            ...
            table.addCell(new Phrase(String.valueOf(producto.getDescripcion()), NORMAL_FONT));
            ...
            table.addCell(new Phrase(String.valueOf(producto.getCantidad()*producto.getPrecio()), NORMAL_FONT));
    ...
    private void addRowsGroup(PdfPTable table, List<Producto> productos) {
        ...
        for (Producto producto : productos) {
            if (currentOrigen == null) {
                ...
                table.addCell(new Phrase(String.valueOf(grouptotal), NORMAL_FONT));
            ...
            grouptotal += producto.getPrecio()*producto.getCantidad();
        }
